...
# -*- coding: utf-8 -*-
"""
Genera la web de reciclajemetal.es.
...
<meta property="og:site_name" content="Reciclaje del metal de 4 horas · Prevención Siglo 21">
...
<header class="cab">
  <div class="wrap cab__in">
    <a class="logo" href="/">
      <span class="logo__marca">Reciclaje <b>metal</b></span>
    ...
    <nav class="nav" aria-label="Principal">
      <ul>
        {menu}
        <li><a class="btn btn--cta" href="/contacto/">Pedir fecha</a></li>
      </ul>
    </nav>
  </div>
</header>
    ...
    <div class="pie__grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="/curso-reciclaje-metal-4-horas/">El curso de 4 horas</a></li>
          <li><a href="/oficios/">Los 15 oficios</a></li>
          <li><a href="/tarjeta-profesional-metal/">La tarjeta del metal</a></li>
...
def main():
    ...
    print("Generando reciclajemetal.es")
